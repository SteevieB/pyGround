...
class Bookshelf:
	...
	def drawSelf(self,screen):
		pygame.draw.rect(screen, rgbBrown, (10,10, self.boardThickness,self.boardLength))
		pygame.draw.rect(screen, rgbBrown, (10,10, self.boardLength,   self.boardThickness))
		pygame.draw.rect(screen, rgbBrown, (10,256,self.boardLength,   self.boardThickness))
		pygame.draw.rect(screen, rgbBrown, (266,10,self.boardThickness,self.boardLength))
